...
- **Open follow-ups (intended TODO)**:
  ...
  2. **Manual descriptions needed** (per project's manual-description standard): plants Windscale AGR, Shidaowan (HPR1000 units), Darlington SMR; and new models (V-510K, V-527/528/529, V-213+, M310+, CPR-1000+, BWRX-300, VBWR, WH 2-loop, VVER-210/365, **+V-412M, V-412T, V-491S, V-491T from 010**). App shows blank gracefully meanwhile.

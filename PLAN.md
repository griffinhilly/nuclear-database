...
- **Open follow-ups (intended TODO)**:
  1. **Ask Noah** for sources on undocumented suffixes V-491S / V-491T / V-412T (applied base codes only). Note V-510K (Kursk II) WAS applied — it has a Wikipedia-VVER-table source, unlike S/T/M. Also tell him the 3 overrides (Ling'ao=M310, Lianjiang=CAP1000, Kudankulam=V-412).
